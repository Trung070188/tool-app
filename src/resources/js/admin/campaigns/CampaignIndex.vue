                            ...
                            <div class="table-responsive">
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="entry in entries">
                                        ...
                                        <td>
                                            <a class="edit-link" :href="'/xadmin/campaigns/edit?id='+entry.id" target="_blank">
                                        ...
                                        <td v-text="entry.daily_install"></td>
                                        <td>
                                        ...
                                        <td>
                                            <switch-button v-model="entry.status" @change="switchStatus(entry)"
                                        ...
                                        <td class="">
                                            <a :href="'/xadmin/campaigns/edit?id='+entry.id" class="btn " target="_blank"><i
