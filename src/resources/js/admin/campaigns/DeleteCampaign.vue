                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header border-0 pt-6">
                                ...
                                <div class="card-toolbar">
                                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base"
                                         style="position: absolute;top: 25px;right: 0px" v-if="campaignIds=='' ">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center d-none"
                                        ...
                                        <button type="button" class="btn btn-danger"
                                                ...
                                                @click="removeAllCampaign">Xóa campaign đã chọn
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <div class="row mb-2">
                                    <button class="btn btn-primary " style="margin: 0px 20px;background-color:#238776">
                                        Xóa data campaign đã chọn
                                    </button>
                                    <button class="btn btn-primary" style="background-color:#238776">Xóa campaign đã
                                        chọn
                                    </button>
                                </div>
                                ...
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="entry in entries">
                                        ...
                                        <td><img v-if="entry.icon && entry.icon.length > 0" :src="entry.icon[0].url"
                                        ...
                                        <td>
                                            <switch-button v-model="entry.status"
                                                           @change="switchStatus(entry)"></switch-button>
                                        </td>
                                        <td>
                                            <switch-button v-model="entry.open_next_day"
                                                           @change="OpenNextDay(entry)"></switch-button>
                                        </td>
