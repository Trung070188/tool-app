                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">Role Index</h4></div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-8">
                                ...
                                <div class="col-xl-4 d-flex">
                                    <div class="margin-left-auto mb-1">
                                        <a href="/xadmin/roles/create" class="btn btn-primary">
                                            <i class="fa fa-plus"/>
                                            Thêm
                                        </a>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="entry in entries">
                                        <td>
                                            <a class="edit-link" :href="'/xadmin/roles/edit?id='+entry.id"
                                               v-text="entry.id"></a>
                                        </td>
                                                                                    <td v-text="entry.code"></td>
                                                                                    <td v-text="entry.name"></td>
                                                                                    <td v-text="entry.display_name"></td>
                                        
                                        <td class="">
                                            <a :href="'/xadmin/roles/edit?id='+entry.id" class="btn "><i
