                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 d-flex">
                                    <div class="margin-left-auto mb-1">
                                        <a href="/xadmin/partners/create" class="btn btn-primary" target="_blank">
                                            <i class="fa fa-plus"/>
                                            Thêm
                                        </a>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="entry in entries">
                                        <td>
                                            <a class="edit-link" :href="'/xadmin/partners/edit?id='+entry.id"
                                               v-text="entry.id"></a>
                                        </td>
                                        ...
                                        <td class="">
                                            <a :href="'/xadmin/partners/edit?id='+entry.id" class="btn " target="_blank"><i
...
export default {
    ...
    methods: {
        async load() {
            ...
            const res = await $get('/xadmin/partners/data', query);
        ...
        async remove(entry) {
            ...
            const res = await $post('/xadmin/partners/remove', {id: entry.id});
        ...
        async toggleStatus(entry) {
            const res = await $post('/xadmin/partners/toggleStatus', {
                id: entry.id,
                status: entry.status
            });
