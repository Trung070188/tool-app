                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3 file-table">
                        ...
                        <div style="margin-bottom: 5px">
                            ...
                            <button type="button" @click="showMoveModal()" class="btn btn-sm btn-primary"
                                    style="margin-left: 5px">
                                Di chuyển
                            </button>
                            <button type="button" @click="removeFiles()" class="btn btn-sm btn-primary"
                                    style="margin-left: 5px">Xóa
                            </button>
                            <button type="button" @click="showPhotos()" class="btn btn-sm btn-primary"
                                    style="margin-left: 5px">Xem
                                ảnh
                            </button>
                        </div>
                        <div style="height: 450px; overflow-y: auto">
                            <table class="table table-striped table-hover table-sm mb-0">
                                ...
                                <tr>
                                    <th style="width: 20px">
                                        <input type="checkbox" v-model="fileCheckedAll"
                                               @change="onCheckAll(fileCheckedAll)">
                                    </th>
                                    ...
                                    <td :title="file.name">
                                        <div class="d-flex align-items-center" v-if="!file.is_folder">
                                            <div style="margin-right: 3px">
                                                <QImage class="img-preview-sm" alt="preview-image" v-if="file.is_image"
                                                        :src="file.url"/>
                                            ...
                                            <div class="font-weight-bold text-danger">
                                                ...
                                                <a href="#" v-else @click.prevent="showPhoto(file)"> {{
                                                        t(file.name)
                                                    }}</a>

                                            </div>
                                        </div>
                                        <div v-else class="d-flex align-items-center CommonPrefixes is-folder"
                                             @click="load(file)">
                                    ...
                                    <td>
                                        <div class="dropdown" v-if="file.name !== '..'">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" @click.prevent="removeFile(file)" href="#">Xóa
                                                    file</a></li>
                                                <li><a class="dropdown-item" @click.prevent="rename(file)" href="#">Đổi
                                                    tên</a></li>
                                            </ul>
                                        </div>
                                    </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" @click="processMoveFile(targetMoveFileId)" class="btn btn-primary">Di
                            chuyển
                        </button>
                        <button @click="closeMoveModal" type="button" class="btn btn-secondary" data-dismiss="modal">
                            Đóng
                        </button>
                    </div>
                </div>
...
<script>
import {$alert, $get, $post, $upload, humanFileSize, uploadObjectUsingPresignedURL} from "../utils";
import moment from "moment";
import draggable from 'vuedraggable'
import QImage from "./QImage";
import {showPhotos, parseHashQuery, inIframe} from "../utils";

let moveFileModal;

import {Q_FILE_ACTION} from '../utils'
